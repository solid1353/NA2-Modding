...
while reusable executable engines remain under `na228_builder/modules/`.
...
preserved in the frozen legacy `docs/HYPOTHESES.md` pending topic-local
migration.
...
- **Dynamic save date/time numerals:** the digits are generated by executable
  code and still require a verified renderer/code mapping; the legacy lead
  remains in the frozen `docs/HYPOTHESES.md` pending topic-local migration; it
  is not part of the executable mapping table.
