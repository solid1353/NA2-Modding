...
The remaining font work still separates into glyph appearance, positioning/advance behavior, and missing NUN5-style auto-fit/squish. Reuse the preserved disassembly under `@source/NA2_disassembly` and `@source/NUN5_disassembly` rather than disassembling the ELFs again.
