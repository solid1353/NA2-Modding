...
- The one-off v23 builder script was removed after its useful result was normalized. Its patch log remains under `logs/font/`; the reproducible test ZIP was retired from the workspace and remains available through Git history.
