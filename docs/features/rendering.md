...
The canonical scope analysis, NUN6 donor evidence, proposed NA2 architecture,
and visual validation matrix are in
[`docs/knowledge/rendering/`](../knowledge/rendering/README.md).
