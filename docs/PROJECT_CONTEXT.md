...
- `na2_patcher/`: profile schemas, ordered module orchestration, immutable module-data snapshots, and the integrated translation engine. `na2_patcher/profiles/current/` pins font m01, runtime-proven `ELF-M008`, and translation m03/v33 by exact hashes. A full profile build is byte-for-byte identical to the verified `build/Current.iso` SHA-256 `2614C6B7D71C4D9BAF39D091FC4194F16F70D0007C5761C72BB9320239BBAD2C`.
