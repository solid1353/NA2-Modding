...
| --- | --- | --- |
| `scripts/research/localization/compose_font_report_grid.py` | `3692c35c` | Retired with the manual epic/report-grid workflow. Screenshot comparisons are generated by the maintained E2E test pipeline. |
