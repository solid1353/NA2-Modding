...
- add the three guarded call-site hooks, compiled helper fragment, and one
  shared ABI shim to the selected battle-owned unified patch;
...
[`damage.md`](../knowledge/gameplay/damage.md).
...
per-call floats are recorded in
[`damage.md`](../knowledge/gameplay/damage.md). Practice displayed the resulting
...
replay documented in [`damage.md`](../knowledge/gameplay/damage.md). Markers
