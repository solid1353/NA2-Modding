...
`ELF-R001` instead changes the initializer's guarded `lui v0,0x3F80`
instruction to `lui v0,0x3F40`, producing `0.75f` through the normal
rendering-state pointer without depending on heap placement.
