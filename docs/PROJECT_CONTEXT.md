...
- Current verified working-build snapshot: `build/Current.iso`, size `1,928,429,568`, SHA-256 `2614C6B7D71C4D9BAF39D091FC4194F16F70D0007C5761C72BB9320239BBAD2C`, boot ELF CRC `08983B71`. It composes the declarative font m01 patch set, runtime-proven raw patch `ELF-M008`, and immutable translation m03/v33 through the current profile. The cleaned-tree profile build matches this ISO byte-for-byte. The active PNACH alias is `cheats/SLPS-25837_08983B71.pnach`.
