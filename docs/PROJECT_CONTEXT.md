...
- `build/`: the active working ISO only, normally `build/Current.iso`. Temporary, parity-check, and hypothesis-test ISOs are deleted immediately after their result is recorded.
