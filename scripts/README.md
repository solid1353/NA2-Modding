...
- `media/`: ISO, AFS, and CVM inspection/extraction tools. The encrypted-CVM
  workflow is `split_cvm_rofs.ps1`; ISO changes belong in hash-pinned profiles,
  not direct file-replacement helpers.
