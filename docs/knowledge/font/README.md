...
- NA2 and UN5 `GF4C.BIN` are both 104 bytes but diverge from offset `0x28`; the v22 and v23 experiments used the UN5 variant. Its independent functional significance remains unproven.
- Replacing NA2 GF4 with the exact UN5 GF4, padded or unpadded, produced broad spacing but patchy glyph rendering and could disrupt PNACH behavior. Do not repeat that direct swap as a new hypothesis.
- The v22 state was clean and closer to UN5, but glyphs could touch or overlap and long text still clipped.
...
The remaining font work still separates into glyph appearance, positioning/advance behavior, and missing UN5-style auto-fit/squish. Reuse the preserved disassembly under `@source/NA2_disassembly` and `@source/UN5_disassembly` rather than disassembling the ELFs again.

Relevant static-analysis leads retained from the investigation:

- NA2 ASCII setup: `FUN_00186510`.
- UN5 counterpart: `FUN_001878e0`.
- UN5 boxed auto-fit: `FUN_00389df0` and `FUN_0018b1b0`.
