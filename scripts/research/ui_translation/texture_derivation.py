...
from na228_builder.infrastructure.orchestration.source_media import (
    IsoFileView,
    cvm_members,
)
...
def source_members(
    na2_root: Path,
    nun5_root: Path,
) -> tuple[IsoFileView, IsoFileView]:
    target, _ = cvm_members(na2_root)
...
def build_plan(
    *,
    ...
    target_iso, donor_iso = source_members(na2_root, nun5_root)
    ...
    return TexturePatchPlan(package, results, worker_count)
